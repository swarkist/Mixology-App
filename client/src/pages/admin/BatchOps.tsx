          ...
          <TabsContent value="paste">
            ...
            <div className="flex gap-2">
              ...
              <Button 
                ...
                disabled={!pasteText}
                className="border-[#f2c40c] text-[#f2c40c] hover:bg-[#f2c40c] hover:text-[#161611] disabled:border-[#666666] disabled:text-[#666666] disabled:bg-transparent disabled:opacity-100"
              >
                Clear
              </Button>
            </div>
